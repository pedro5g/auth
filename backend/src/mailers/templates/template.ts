...
export const magicLinkAuthenticationTemplate = (
  url: string,
  brandColor: string = "#2563EB"
) => ({
  subject: "Sign In to Your Account",
  text: `To sign in to your account, please click the following link: ${url}`,
  html: `
    <html><head><style>
      body, html { margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4; color: #333333; }
      .container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); }
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p>We received a request to sign in to your account. Click the button below to sign in securely:</p>
